...
\addbibresource{biblio_geosciences.bib} %Import the bibliography file
...
We define (see for instance \textcite{maqs06} (2006)) four reference 
...
\]
One can recognise in this equation the Reynolds\footnote{\url{https://en.wikipedia.org/wiki/Reynolds_number}} and Froude\footnote{\url{https://en.wikipedia.org/wiki/Froude_number}} 
...
\begin{center}
\fbox{\includegraphics[width=7cm]{images/sope_01}}\cite{sope90}
\end{center}

\begin{center}
\fbox{\includegraphics[width=14cm]{images/sope_02}}\cite{sope90}\\
{\tiny I agree with these, standard conservation equations.}
\end{center}

\begin{center}
\fbox{\includegraphics[width=14cm]{images/sope_03}}\cite{sope90}
\end{center}


\begin{center}
\fbox{\includegraphics[width=14cm]{images/sope_04}}\cite{sope90}
\end{center}

The authors then explain why the $\partial \rho/\partial t$ term can be 
neglected:
\begin{center}
\fbox{\includegraphics[width=14cm]{images/sope_05}}\cite{sope90}
\end{center}

They then present the formulation for the radial pressure (In the equations the density $\rho$ should be the radial density):
\begin{center}
\fbox{\includegraphics[width=14cm]{images/sope_06}}
\fbox{\includegraphics[width=14cm]{images/sope_07}}\cite{sope90}\\
...
can be set to zero:
\begin{center}
\fbox{\includegraphics[width=14cm]{images/sope_08}}\cite{sope90}\\
...
throughout the entire mantle (\textcite{dzan81}, 1981), we will set 
...
\begin{center}
\fbox{\includegraphics[width=14cm]{images/sope_09}}\cite{sope90}
\end{center}
It also leads to a different set of equations:
\begin{center}
\fbox{\includegraphics[width=14cm]{images/sope_10}}\cite{sope90}
\end{center}
...
We start from \textcite{itki94} (1994).
...
\begin{center}
\fbox{\includegraphics[width=8cm]{images/itki_08}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=8cm]{images/itki_12}}\cite{itki94}
\end{center}
...
However, we read in \textcite{vacp22}: 
\begin{displayquote}  {\color{darkgray}
The anelastic liquid approximation (ALA; 
\textcite{jamc80}, 1980) assumes that lateral density variations are
...
Also, when we look in \textcite{lezh08} (I come back to this article in Section~\ref{complezh08}):
\begin{center}
\fbox{\includegraphics[width=17cm]{images/lezh_01}}
\end{center}
...
%------------------------------------------------------------------------
\subsubsection{TALA}
We further read in \textcite{itki94}:
\begin{displayquote}  {\color{darkgray}
...
\fbox{\includegraphics[width=8cm]{images/itki_10}
...
\fbox{\includegraphics[width=16cm]{images/lezh_01}}\cite{lezh08}
...
\item We find a TALA formulation in \textcite{ilkm26} (2026):
\begin{center}
\fbox{\includegraphics[width=8cm]{images/ilkm01}
\includegraphics[width=8cm]{images/ilkm02}}\\
\fbox{\includegraphics[width=8cm]{images/ilkm03}}\cite{ilkm26}
\end{center}

\item Likewise in \textcite{kame22} we find:
\begin{center}
\fbox{
...
\fbox{\includegraphics[width=8cm]{images/kame22e}}
\end{center}
...
Coming back to \textcite{itki94} we read in the article:
\begin{displayquote}  {\color{darkgray}
...
The Boussinesq approximation is examined in detail in \textcite{spve60} (1960).

We read in \textcite{tack96} (1996):
\begin{displayquote} {\color{darkgray}
...
\begin{center}
\fbox{\includegraphics[width=17cm]{images/lezh_01}}\cite{lezh08}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=17cm]{images/lezh_02}}\cite{lezh08}
\end{center}
...
In \textcite{jamc80} (1980) we find:
\[
...
\begin{center}
\fbox{\includegraphics[width=17cm]{images/lezh_03}}\cite{lezh08}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=17cm]{images/lezh_04}}\cite{lezh08}
\end{center}

\begin{center}
\fbox{\includegraphics[width=17cm]{images/lezh_05}}\cite{lezh08}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=17cm]{images/lezh_06}}\cite{lezh08}
\end{center}
\[
\frac{1}{\rho_r} \frac{d \rho_r}{dz} = - \frac{\alpha g}{C_p \Gamma} \gamma
\]
\begin{center}
\fbox{\includegraphics[width=17cm]{images/lezh_07}}\cite{lezh08}
\end{center}
\[
-\vec\nabla p + \vec\nabla \cdot {\bm \tau} +  ...
\]
...
\vspace{1cm}
\begin{center}
\fbox{\includegraphics[width=17cm]{images/lezh_08}}\cite{lezh08}
\end{center}
\begin{center}
\fbox{\includegraphics[width=17cm]{images/lezh_09}}\cite{lezh08}
\end{center}
...
\fbox{\includegraphics[width=16cm]{images/lezh_10}}
...
\fbox{\includegraphics[width=16cm]{images/lezh_11}}
...
\fbox{\includegraphics[width=16cm]{images/lezh_12}}
...
\fbox{\includegraphics[width=16cm]{images/lezh_13}}
...
\fbox{\includegraphics[width=16cm]{images/lezh_14}}
...
\fbox{\includegraphics[width=16cm]{images/lezh_15}}
...
\begin{center}
\fbox{\includegraphics[width=8cm]{images/kilv10a}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=8cm]{images/kilv10b}}
\fbox{\includegraphics[width=8cm]{images/kilv10c}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=8cm]{images/kilv10d}}
\end{center}

\begin{center}
\fbox{\includegraphics[width=8cm]{images/kilv10e}}
\end{center}
Please refer to Section~\ref{sec:eos} for more on equations of state.

\begin{center}
\fbox{\includegraphics[width=8cm]{images/kilv10f}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=8cm]{images/kilv10g}}
\fbox{\includegraphics[width=8cm]{images/kilv10h}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=8cm]{images/kilv10i}}
\fbox{\includegraphics[width=8cm]{images/kilv10j}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=8cm]{images/kilv10k}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=8cm]{images/kilv10l}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=8cm]{images/gadb20a}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=7cm]{images/civj17a}}
\fbox{\includegraphics[width=7cm]{images/civj17b}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=7cm]{images/kilv10}}\cite{kilv10}
\hspace{1cm}
\fbox{\includegraphics[width=7cm]{images/itki_03}}\cite{itki94}
\end{center}

\begin{center}
\fbox{\includegraphics[width=7cm]{images/lee_13}}\cite{lee_13}
\hspace{1cm}
\fbox{\includegraphics[width=7cm]{images/trub08}}\cite{trub08}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=7cm]{images/jape82}}\cite{jape82} \hspace{1cm}
\fbox{\includegraphics[width=7cm]{images/mayu89}}\cite{mayu89}
\end{center}
\begin{center}
\fbox{\includegraphics[width=16cm]{images/lezh_04}}\cite{lezh08}
\end{center}

\begin{center}
\fbox{\includegraphics[width=7cm]{images/lizh13}}\cite{lizh13}
\hspace{1cm}
\fbox{\includegraphics[width=7cm]{images/civj17}}\cite{civj17}
\end{center}
...
See section 2.2 of \fullcite{zhyu96b}
...
In \textcite{zhyu96b} (1996) we find confirmation:
\begin{displayquote}
{\color{darkgray}
...
As explained in \textcite{lezh11} the discretised mass and momentum conservation
...
Note that in \textcite{lezh11} so-called $Q_1\times Q_1$ 
